...
var _VersionInfo="Version:2003 "	//版本信息

//==================================================== WEB 页面显示部分 =====================================================
var strFrame;		//存放日历层的HTML代码
document.writeln('<iframe id=meizzDateLayer Author=wayx frameborder=0 style="position: absolute; width: 150; height: 220; z-index:100001; display: none"></iframe>');
strFrame='<style>';
...
strFrame+='</scr' + 'ipt>';
strFrame+='<div style="z-index:100002;position: absolute; left:0; top:0;" onselectstart="return false"><span id=tmpSelectYearLayer Author=wayx style="z-index:100002;position: absolute;top: 3; left: 19;display: none"></span>';
strFrame+='<span id=tmpSelectMonthLayer Author=wayx style="z-index:100002;position: absolute;top: 3; left: 78;display: none"></span>';
