...
public class SimpleByteRange implements ByteRange {
	...
	/**
	 * Variable for lazy-caching the hashCode of this range. Useful for frequently used ranges, long-lived ranges, or
	 * long ranges.
	 */
	...
	/**
	 * Create a new {@code ByteRange} over a new backing array of size {@code capacity}. The range's offset and length
	 * are 0 and {@code capacity}, respectively.
	 * 
	 * @param capacity
