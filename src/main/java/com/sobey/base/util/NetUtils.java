...
public class NetUtils {
	 ...
	 * @param defaultPort
	 *            the default port if <code>target</code> does not include a port number
	 * @param configName
	 *            the name of the configuration from which <code>target</code> was loaded. This is used in the exception
	 ...
	 * {@link NetUtils#addStaticResolution(String, String)}. The return value is a List each element of which contains
	 * an array of String of the form String[0]=hostname, String[1]=resolved-hostname
	 * 
	 ...
	 * 
	 * @param name
	 *            a string representation of a host: either a textual representation its IP address or its host name
