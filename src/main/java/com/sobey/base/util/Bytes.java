 ...
 */
public class Bytes extends com.sobey.jcg.support.utils.Bytes {
	...
	/**
	 * A {@link ByteArrayComparator} that treats the empty array as the largest value. This is useful for comparing row
	 * end keys for regions.
	 */
	 ...
	 *             if length is not {@link #SIZEOF_LONG} or if there's not enough room in the array at the offset
	 *             indicated.
	 */
	 ...
	 * @return the int value
	 * @throws IllegalArgumentException
	 *             if length is not {@link #SIZEOF_INT} or if there's not enough room in the array at the offset
	 *             indicated.
	 */
	...
	/**
	 * Returns the start position of the first occurrence of the specified {@code target} within {@code array}, or
	 * {@code -1} if there is no such occurrence.
	 * 
	 * <p>
	 * More formally, returns the lowest index {@code i} such that
	 * {@code java.util.Arrays.copyOfRange(array, i, i + target.length)} contains exactly the same elements as
	 * {@code target}.
	 * 
	 * @param array
