...
import com.sobey.base.exception.ConfigException;
import com.sobey.base.exception.DbException;
...
public class CheckAndUpdateDb {
	...
	static void checkTableVersion(DataAccess access) {
