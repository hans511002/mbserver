 ...
 */
public class MD5Hash extends DigestUtils {
	...
	/**
	 * Given a byte array, returns its MD5 hash as a hex string. Only "length" number of bytes starting at "offset"
	 * within the byte array are used.
	 * 
	 * @param key
